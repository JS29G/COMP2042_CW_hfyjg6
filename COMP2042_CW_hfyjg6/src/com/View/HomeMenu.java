...
public class HomeMenu extends JComponent implements MouseListener, MouseMotionListener {
    ...
    private void drawButton(Graphics2D g2d){
        ...
        Rectangle2D startTxtRect = buttonFont.getStringBounds(START_TEXT,frc);
        Rectangle2D menuTxtRect = buttonFont.getStringBounds(MENU_TEXT,frc);
        Rectangle2D guideTxtRect = buttonFont.getStringBounds(MENU_TEXT,frc);
        ...
        x = (int)(menuButton.getWidth() - menuTxtRect.getWidth()) / 2;
        y = (int)(menuButton.getHeight() - menuTxtRect.getHeight()) / 2;
    ...
    public void mouseMoved(MouseEvent mouseEvent) {
        Point p = mouseEvent.getPoint();
        if(startButton.contains(p) || menuButton.contains(p) || guideButton.contains(p))
